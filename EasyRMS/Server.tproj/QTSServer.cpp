...
{
    static const UInt32 kRecordSessionMapSize = 3000;
    ...
    fRecordSessionMap = new OSRefTable(kRecordSessionMapSize);
...
void    QTSServer::LoadCompiledInModules()
{
	...
	QTSSModule* theRecordModule = new QTSSModule("EasyRecordModule");
    (void)theRecordModule->SetupModule(&sCallbacks, &EasyRecordModule_Main);
